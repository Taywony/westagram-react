      ...
      <nav className="navContainer">
        <div className="navBox">
          <div className="navLeft">
            <img alt="instagram icon" className="navIcon" src="images/아이콘.png"></img>
            <h1 className="feedLogo">Instagram</h1>
          </div>
          <input type="text" placeholder="검색" className="navSearch"></input>
          <div className="navRight">
            <button className="searchBtn">
              <img src="images/탐색.png" alt="search icon" className="searchIcon" />
            </button>
            <button className="heartBtn">
              <img src="images/하트.png" alt="like icon" className="heartIcon" />
            </button>
            <button className="mypageBtn">
              <img src="images/마이페이지.png" alt="my page" className="mypageIcon" />
            </button>
          </div>
        </div>
      </nav>
        ...
        <article className="feed">
          <div className="feedTop">
            <div className="userInfo">
              <img alt="my_photo" className="photo" src="images/user/user1.jpg" />
              <p className="nickName">apple_official</p>
            </div>
            <button className="moreBtn">
              <img alt="more" className="more" src="images/dot.svg"></img>
            </button>
          </div>
          <div className="feedMain">
            <img alt="main_image" className="feedImg" src="images/무지개사과.jpeg" />
          </div>
          <div className="feedBottom">
            ...
            <div className="like">
              <img alt="user" class="photo" src="images/user/user2.jpg" />
            ...
            <div className="postCommentBox">
              <div className="commentList">
                  ...
                  <button className="commentLikeBtn">
                    <img alt="like" src="images/commentHeart.svg" className="commentLikeIcon" />
                  </button>
              </div>
            </div>
        ...
        <div className="feedSub">
          <div className="subMe">
            <div className="subMeLeft">
              <img src="images/user/user3.jpg" className="subImg" />
            </div>
          ...
          <div className="subStory">
            ...
            <div className="subStoryList">
              <div className="user">
                <img src="images/user/user4.jpg" className="photo" />
              ...
              <div class="user">
                <img src="images/user/user5.jpg" className="photo" />
                <div className="nameTime">
              ...
              <div className="user">
                <img src="images/user/user6.jpg" className="photo" />
                <div className="nameTime">
              ...
              <div className="user">
                <img src="images/user/user7.jpg" className="photo" />
                <div className="nameTime">
              ...
              <div className="user">
                <img src="images/user/user8.jpg" className="photo" />
                <div className="nameTime">
              ...
              <div className="user">
                <img src="images/user/user9.jpg" className="photo" />
                <div className="nameTime">
              ...
              <div className="user">
                <img src="images/user/user10.jpg" className="photo" />
                <div className="nameTime">
          ...
          <div className="subRecommend">
            ...
            <div className="subRecommendList">
              <div className="user">
                <img src="images/user/user11.jpg" className="photo" />
                <div className="nameTime">
              ...
              <div className="user">
                <img src="images/user/user12.jpg" className="photo" />
                <div className="nameTime">
              ...
              <div className="user">
                <img src="images/user/user13.jpg" className="photo" />
                <div className="nameTime">
          ...
          <div className="pageInfo">
            <p className="infoList">Instagram 정보, 지원, 홍보 센터, API,채용 정보,개인정보처리방침,약관,디렉터리,프로필,해시테그,언어</p>
